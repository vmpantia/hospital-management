...
const Button = (props:Props) => {
    ...
    switch(type) {
        case "primary":
            styleBtn += "text-white bg-blue-600 hover:bg-blue-700 focus:bg-blue-700";
            break;
        case "secondary":
            styleBtn += "text-white bg-slate-600 hover:bg-slate-700 focus:bg-slate-700";
            break;
        case "success":
            styleBtn += "text-white bg-emerald-600 hover:bg-emerald-700 focus:bg-emerald-700";
            break;
        case "danger":
                styleBtn += "text-white bg-red-600 hover:bg-red-700 focus:bg-red-700";
                break;
        case "warning":
                styleBtn += "text-white bg-amber-600 hover:bg-amber-700 focus:bg-amber-700";
                break;
        case "dark":
